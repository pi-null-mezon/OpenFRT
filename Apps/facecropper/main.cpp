...
const cv::String _options = "{help h            |       | this help                                                     }"
                            ...
                            "{targetheight      | 200   | target image height                                           }"
                            "{hportion          | 1.5   | target horizontal face portion                                }"
                            "{vportion          | 1.5   | target vertical face portion                                  }"
...
int main(int argc, char *argv[])
{
    ...
    _cmdparser.about("Utility to crop faces from images or videos without face alignment");
