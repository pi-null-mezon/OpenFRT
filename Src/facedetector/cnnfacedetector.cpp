...
{
    cv::Mat blob;
    cv::Size _targetsize(140, 140 * _img.rows()/_img.cols()); // greater values could provide detection of smaller faces but processing time will increase proportionally
